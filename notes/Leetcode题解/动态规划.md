...
=================
   ...
   * [斐波那契数列](#斐波那契数列)
      * [<a href="">1. 爬楼梯</a>](#1-爬楼梯)
      * [<a href="">2. 强盗抢劫</a>](#2-强盗抢劫)
   ...
   * [0-1 背包](#0-1-背包)
      ...
      * [7. 组合总和](#7-组合总和)
   * [股票交易](#股票交易)
      * [1. 不需要冷却期的股票交易](#1-不需要冷却期的股票交易)
      * [2. 需要冷却期的股票交易](#2-需要冷却期的股票交易)
      * [3. 需要交易费用的股票交易](#3-需要交易费用的股票交易)
      * [4. 只能进行两次的股票交易](#4-只能进行两次的股票交易)
      * [5. 只能进行 k 次的股票交易](#5-只能进行-k-次的股票交易)
   * [字符串编辑](#字符串编辑)
...
[Leetcode (opens new window)](https://leetcode.com/problems/2-keys-keyboard/description/)/ [力扣(opens new window)](https://leetcode-cn.com/problems/2-keys-keyboard/description/)
